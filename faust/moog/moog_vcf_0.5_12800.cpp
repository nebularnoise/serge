...
class mydsp : public dsp {
  ...
  public:
	virtual void metadata(Meta* m) { 
		m->declare("name", "moog_vcf_0.5_12800");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst2 = (((fConst1 + 2.999f) / fConst0) + 2.4980004f);
		fConst3 = ((((fConst1 + -2.999f) / fConst0) + 2.4980004f) / fConst2);
		...
		fConst18 = (((fConst1 + 1.001f) / fConst0) + 0.5000005f);
		fConst19 = ((((fConst1 + -1.001f) / fConst0) + 0.5000005f) / fConst18);
