  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp3 = (1 - (fConst3 * (fTemp2 / powf(2.0f,((2.0f * (1.0f - fRec2[0])) + 1.0f)))));
			fRec1[0] = ((0.999f * fRec1[1]) + (0.001f * faustpower<2>(fTemp3)));
			fRec3[0] = ((0.999f * fRec3[1]) + (0.001f * (0 - (2.0f * (fTemp3 * cosf((fConst4 * fTemp2)))))));
			fRec4[0] = ((0.999f * fRec4[1]) + (0.0001f * powf(4.0f,fRec2[0])));
			fRec0[0] = ((fTemp0 * fRec4[0]) - ((fRec0[1] * fRec3[0]) + (fRec0[2] * fRec1[0])));
			output0[i] = (FAUSTFLOAT)((0.75f * fTemp0) + (0.25f * (fRec0[0] - fRec0[1])));
			// post processing
