...
class mydsp : public dsp {
  ...
  public:
	virtual void metadata(Meta* m) { 
		m->declare("name", "moog_vcf_1_12800");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst2 = (((fConst1 + 3.998f) / fConst0) + 4.994002f);
		fConst3 = ((((fConst1 + -3.998f) / fConst0) + 4.994002f) / fConst2);
		...
		fConst18 = (((fConst1 + 0.002f) / fConst0) + 0.998002f);
		fConst19 = ((((fConst1 + -0.002f) / fConst0) + 0.998002f) / fConst18);
