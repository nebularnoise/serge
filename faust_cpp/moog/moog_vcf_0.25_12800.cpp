...
class mydsp : public dsp {
  ...
  public:
	virtual void metadata(Meta* m) { 
		m->declare("name", "moog_vcf_0.25_12800");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst0 = tanf((40212.387f / min(1.92e+05f, max(1.0f, (float)fSamplingFreq))));
		fConst1 = (1.0f / fConst0);
		fConst2 = (((fConst1 + 2.4995f) / fConst0) + 1.6242502f);
		fConst3 = ((((fConst1 + -2.4995f) / fConst0) + 1.6242502f) / fConst2);
		...
		fConst18 = (((fConst1 + 1.5005f) / fConst0) + 0.6252501f);
		fConst19 = ((((fConst1 + -1.5005f) / fConst0) + 0.6252501f) / fConst18);
